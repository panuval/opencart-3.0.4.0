...
class ControllerExtensionShippingXshippingpro extends Controller {
    ...
    private $setting = array(
        ...
        'xshippingpro_admin_menu'  => '',
        'xshippingpro_disable_cache'  => '',
        'xshippingpro_debug'       => '',
    ...
    private $events = array(
        ...
        array(
            'trigger' => 'catalog/controller/api/order/update_sup_options/before',
            'action'  => 'extension/shipping/xshippingpro/on_update_sup_options'
        ),
        array(
            'trigger' => 'catalog/controller/api/order/get_sup_options/before',
    ...
    public function __construct($registry) {
        ...
        $this->events[] = array(
            'trigger' => 'catalog/view/mail/order' . $order_email . '/before',
